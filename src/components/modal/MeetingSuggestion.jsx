...
function MeetingSuggestion({
  ...
  const handleSubmit = (event) => {
    ...
    onSubmit?.({ startDate, endDate, duration });
  };
  ...
  return (
    ...
    >
      <section
        className="h-[542px] rounded-28 bg-white p-6"
      >
        <form
          onSubmit={handleSubmit}
          className="flex h-full w-100 flex-col items-end justify-between"
        >
          <div className="flex w-full flex-col items-end gap-2.5">
            ...
            <div className="flex w-full flex-col gap-5">
              <h2 className="text-title1 text-gray-900">
                Meeting Suggestions
              </h2>
